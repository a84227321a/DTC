...
def gen_seal(width,height,font_path,text):
    font_size =20
    font = ImageFont.truetype(font_path, font_size)
    ori_text_image = Image.new("RGBA", (width, height), (255, 255, 255, 0))
    for tx in text:
        ori_text_image = ori_text_image.rotate(20)
...
if __name__ == '__main__':
    ...
    height = 300
    text = 'world'
    font_path = r'F:\code\GTC\get_data\font\ARIALNBI.TTF'
    gen_seal(width,height,font_path,text)